...
:_pvCtx Scilab environment pointer, pass in "pvApiCtx" provided by
  api_scilab.h
: :_piAddress The address of the variable
: :_pstName Scilab variable name.
: :_piType Scilab type of the variable (sci_matrix, sci_strings,
  sci_ints, ...). Note that the list of the different variable types is
  available as an enum in `sci_types.h`_.
...
This help describes how to retrieve the Scilab type of a variable in a
gateway.
